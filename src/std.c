 ...
 * and add the devices on the list to the driver's device instance list. Usually
 * it should be used as the last step in the scan() callback, right before
 * returning.
 *
 * Note: This function can only be used std_init() has been called previously by
 * the driver.
 *
 * Example:
 * @code{c}
